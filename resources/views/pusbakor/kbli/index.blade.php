...
<div class="ms-md-auto pe-md-3 d-flex align-items-center">
    <div class="container font-weight-bold text-dark">
        <a href="/kbli/create" class="btn btn-success btn-sm m-3">
        ...
        <span class="text-white">Tambah KBLI</span>
    </div>
    <form action="/kbli" method="GET" class="col-4">
        <div class="input-group">
            <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
            <input type="search" name="search" class="form-control" placeholder="Search Judul KBLI">
        </div>
    </form>
</div>
    <thead>
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('kbli.destroy', $k->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="kbli/{{ $k['id'] }}/edit" class="btn btn-info btn-sm"><svg
