...
<div class="container font-weight-bold text-dark">
    <a href="/jenis_perusahaan/create" class="btn btn-success btn-sm m-3">
    ...
    <span class="text-white">Tambah Jenis Perusahaan</span>
</div>
    <thead>
        <tr>
            <th>No</th>
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('jenis_perusahaan.destroy', $jp->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="jenis_perusahaan/{{ $jp['id'] }}/edit" class="btn btn-info btn-sm"><svg
