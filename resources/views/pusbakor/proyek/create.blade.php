            ...
            <div class="card-body p-3">
                <form action="{{ route('proyek.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" placeholder="Masukkan Longitude" aria-label="longitude"
                            id="longitude" value="{{ old('longitude') }}" name="longitude" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" placeholder="Masukkan Investasi" aria-label="investasi"
                            id="investasi" value="{{ old('investasi') }}" name="investasi" required>
                    </div>
                    <div class="mb-3">
                        <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="custom-select" name="modals" required>
                        ...
                        <select class="custom-select" name="kecamatan" required>
                            ...
                            @foreach ($kecamatan as $kec)
                                @if (old('kecamatan') == $kec['id'])
                                    <option value="{{ $kec['id'] }}" selected> {{ $kec['nama_kecamatans'] }}</option>
                                @else
