...
<div class="container font-weight-bold text-dark">
    <a href="/skalausaha/create" class="btn btn-success btn-sm m-3">
    ...
    <span class="text-white">Tambah Skala Usaha</span>
</div>
    <thead>
        <tr>
            <th>No</th>
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('skalausaha.destroy', $su->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="skalausaha/{{ $su['id'] }}/edit" class="btn btn-info btn-sm"><svg
